...
public class ScoreList {
  ...
  /**
   * Shuning
   * Sort the list by score and external document id reversely.
   */
  public void reverseSort(){ Collections.sort(this.scores,Collections.reverseOrder(new ScoreListComparator()));
  }
